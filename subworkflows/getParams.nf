...
workflow param_selection_workflow {
    ...
    main:
    // param_file_outs = getParamName_noDocker(taxid, update_list, params_path) | paramSplit

    param_file_down = getParamName_noDocker(taxid, update_list, params_path)
    param_file_outs = paramSplit(param_file_down)

    // param_file_down = getParamName_noDocker(taxid, update_list, params_path) | copyParamDocker

    // param_file_down = getParamName(taxid, update_list, params) | copyParamDocker
    // param_file_outs = paramSplit(param_file_down)
